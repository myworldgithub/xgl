...
int64 nChainStartTime = 1524022970;
...
const string strMessageMagic = "NewTechnologyCreateCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NewTechnologyCreateCoin
    bool fStrictPayToScriptHash = true; // Always active in NewTechnologyCreateCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NewTechnologyCreateCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector NewTechnologyCreateCoin empty mapBlockIndex NewTechnologyCreateCoin NewTechnologyCreateCoin";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xa3756f4dd05dad0f1fc5482ae5ff25f561d602553e6def8fc56bcd7c099c37c2"));
