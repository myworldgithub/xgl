TEMPLATE = app
TARGET = NewTechnologyCreateCoin-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = NewTechnologyCreateCoin-qt_test
...
macx:ICON = src/qt/res/icons/NewTechnologyCreateCoin.icns
macx:TARGET = "NewTechnologyCreateCoin-Qt"
